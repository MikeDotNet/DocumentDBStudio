...
namespace Microsoft.Azure.DocumentDBStudio
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void textBoxFilter_TextChanged(object sender, EventArgs e)
        {
            ...
            //TextBox tbx = Form.ActiveForm.Controls.Find("textBoxFilter", true).FirstOrDefault() as TextBox;
            ...
            //{
            //    foreach (TreeNode _parentNode in Program._TreeViewCache)
            //    {
            //        foreach (TreeNode _childNode in _parentNode.Nodes)
            //        {
            //            if (_childNode.Text.StartsWith(tbx.Text))
            //            {
            //                this.treeView1.Nodes.Add((TreeNode)_childNode.Clone());
            //            }
            //        }
            //    }
            //}
            //else
            //{
            //    foreach (TreeNode _node in Program._TreeViewCache)
            //    {
